...
- Три типа образуют цепочку Blob → Toxic Blob → Plasma Blob. ReleaseMutant предотвращает заполнение всех слотов высшим tier; без возврата валюты и после обучения.
- Первый бой требует merge и мутанта ToxicBlob либо PlasmaBlob. После завершения обучения можно тренировать Blob. Ранний merge до Plasma не должен блокировать прогресс.
